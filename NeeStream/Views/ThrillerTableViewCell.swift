...
class ThrillerTableViewCell: UITableViewCell,modeldelegate {
    
    static let cellId = "ThrillerTableViewCell"
    ...
    func categoriesFetched(_ categories: [Categories]) {
        ...
        thrillerCollectionView.reloadData()
    }
...
extension ThrillerTableViewCell: UICollectionViewDelegate,UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: ThrillerCollectionViewCell.cellId , for: indexPath) as? ThrillerCollectionViewCell
...
extension ThrillerTableViewCell: UICollectionViewDelegateFlowLayout{
