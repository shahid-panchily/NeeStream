...
class RomanceTableViewCell: UITableViewCell,modeldelegate {
    static let cellId = "RomanceTableViewCell"
    @IBOutlet weak var movieSectionLabel: UILabel!
    @IBOutlet weak var romanceCollectionView: UICollectionView!
    ...
    override func awakeFromNib() {
        super.awakeFromNib()
        self.romanceCollectionView.delegate = self
        self.romanceCollectionView.dataSource = self
        model.getData()
        model.delegate = self
...
extension RomanceTableViewCell: UICollectionViewDelegate,UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: RomanceCollectionViewCell.cellId , for: indexPath) as? RomanceCollectionViewCell
...
extension RomanceTableViewCell: UICollectionViewDelegateFlowLayout{
