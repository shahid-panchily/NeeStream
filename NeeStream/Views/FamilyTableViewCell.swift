...
class FamilyTableViewCell: UITableViewCell,modeldelegate {
    
    static let cellId = "FamilyTableViewCell"
...
extension FamilyTableViewCell: UICollectionViewDelegate,UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: FamilyCollectionViewCell.cellId , for: indexPath) as? FamilyCollectionViewCell
...
extension FamilyTableViewCell: UICollectionViewDelegateFlowLayout{
